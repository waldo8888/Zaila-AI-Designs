        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr] pb-12">
            ...
            <div>
              ...
              <p className="text-[14px] leading-[1.8] text-zinc-500 max-w-xs mb-6">
            ...
            {/* Navigation columns */}
            <div>
              <h3 className="text-[11px] uppercase tracking-[0.2em] text-zinc-600 mb-5">
                Navigation
              </h3>
              <nav className="space-y-3">
                {[
                  ...
                  <button
                    ...
                    className="block text-[13px] text-zinc-500 hover:text-white transition-colors"
                  >
                    {item.label}
                  </button>
                ))}
            ...
            <div>
              ...
              <nav className="space-y-3">
                <span className="block text-[13px] text-zinc-500">Websites</span>
                <span className="block text-[13px] text-zinc-500">AI Chatbots</span>
                <span className="block text-[13px] text-zinc-500">Automation</span>
                <span className="block text-[13px] text-zinc-500">Growth Plans</span>
              </nav>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <span className="block text-[13px] text-zinc-500">Hamilton, ON</span>
              </div>
            </div>
          </div>
